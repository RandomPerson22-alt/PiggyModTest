...
public class EntityZompiggy extends EntityPiggyBase {
    public EntityZompiggy(World worldIn) {
        super(worldIn);
    }
	 ...
	 public void updatePassenger(Entity passenger) {
	     if (this.isPassenger(passenger)) {
	         ...
	         float yOffset = -0.4F;      // Height (1.2 blocks above Piggy)
    ...
    public SoundEvent getJumpscareSound() {
        return ModSounds.ENTITY_ZOMPIGGY_JUMPSCARE;
    }
